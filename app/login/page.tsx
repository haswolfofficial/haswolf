    ...
    if (error || !data.session) {
      ...
      setMessage(
        raw.toLowerCase().includes("anonymous sign-ins are disabled")
          ? "Misafir girişleri Supabase tarafında henüz etkin değil. Authentication → Sign In / Providers → Allow anonymous sign-ins seçeneğini açıp alttaki Save changes düğmesine bas."
          : raw,
      );
      setLoading("");
      return;
