          ...
          <div className="haswolf-topbar">
            ...
            <div className="haswolf-header-trade">
              <button type="button" onClick={() => goToMarket("item")} className="haswolf-header-trade__buy">
                <span aria-hidden="true">ğŸ›’</span><span><strong>Bizden SatÄ±n Al</strong><small>Market Ã¼rÃ¼nlerini incele</small></span>
              </button>
              <button type="button" onClick={() => openWhatsApp("Merhaba Haswolf, Item, Yang veya DC satmak istiyorum. Teklif almak istiyorum.")} className="haswolf-header-trade__sell">
                <span aria-hidden="true">ğŸ’°</span><span><strong>Bize Sat</strong><small>HÄ±zlÄ± teklif al</small></span>
              </button>
            </div>
          ...
          <div>
            ...
            <div className="mt-5 max-w-xl">
              <div className="haswolf-hero-quick-links">
                  ...
                  <a href="/cekilis">â˜… Ã‡ekiliÅŸ Merkezi</a>
                </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="haswolf-server-actions mt-4">
                    ...
                    <button
                      type="button"
                      onClick={() => openWhatsApp(`Merhaba Haswolf, ${server.name} sunucusunda Yang veya oyun iÃ§i varlÄ±k satmak istiyorum.`)}
                    ...
                    {group.products.length > 0 ? group.products.map((pack) => (
                      <article key={pack.id} className="haswolf-yang-card">
                        ...
                        <div className="haswolf-yang-card__content">
                          ...
                          <div className="haswolf-yang-card__meta">
                            <span>Stok: {pack.stock}</span>
                            <button type="button" onClick={() => openWhatsApp(`Merhaba Haswolf, ${group.name} sunucusu için ${pack.name} DC ilanını satın almak istiyorum.`)}>WhatsApp ile SatÄ±n Al</button>
                          </div>
                        </div>
                      </article>
