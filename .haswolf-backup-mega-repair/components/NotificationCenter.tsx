    ...
    <>
        ...
        {open && (
          <aside id="haswolf-notification-panel" className="haswolf-notification-panel">
            <header>
              ...
              <button type="button" onClick={() => setOpen(false)} aria-label="Kapat">Ã—</button>
            </header>
                  ...
                  return (
                    ...
                    >
                      ...
                      <span>
                        ...
                        <small>{deal.server} Â· %{pct} indirim</small>
                        <span>
      ...
      {activeDeal && (
        <aside className={`haswolf-sale-toast ${toastVisible ? "is-visible" : ""}`} aria-live="polite">
          <button onClick={closeToast} aria-label="Bildirimi kapat">Ã—</button>
          ...
          <p>KapatÄ±nca Bildirimler alanÄ±nda kalÄ±r.</p>
        </aside>
      )}
    </>
  );
