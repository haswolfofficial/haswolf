          ...
          {markets.map((market) => {
            ...
            return (
              <div className={`haswolf-yang-terminal__row is-${direction}`} key={market.server}>
                ...
                <span className="haswolf-yang-terminal__current"><b>₺{formatTl(market.current)}</b><small>güncel</small></span>
